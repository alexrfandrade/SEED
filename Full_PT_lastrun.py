...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_explain_rate = visual.TextStim(win=win, name='text_explain_rate',
        text="\nPrime a tecla indicada como '1', '2', ou '3' no teclado (por cima da barra espaço) para selecionar o nível de congruência /compatibilidade do par.\n\n\nPrime ESPAÇO para um exemplo",
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_item = visual.TextStim(win=win, name='text_item',
        text='Prime a flecha esquerda <- se a imagem for ANTIGA\n\nPrime a flecha direita -> se a imagem for NOVA',
        font='Arial',
        pos=(0, 0.35), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisExemplo_PAL in exemplo_PAL:
        ...
        while continueRoutine:
            ...
            if key_ex_rate.status == STARTED and not waitOnFlip:
                theseKeys = key_ex_rate.getKeys(keyList=['z','x','c'], ignoreKeys=["escape"], waitRelease=False)
    ...
    for thisTrial_encode in trial_encode:
        ...
        while continueRoutine:
            ...
            if key_rate.status == STARTED and not waitOnFlip:
                theseKeys = key_rate.getKeys(keyList=['z','x','c'], ignoreKeys=["escape"], waitRelease=False)
